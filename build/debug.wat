(module
 ...
 (func $assembly/containerContent/PackV1 (param $bodyBytes i32) (param $nonce i32) (result i32)
  (local $buf i32)
  (local $3 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 12
 ...
 (func $assembly/containerContent/ContainerPack (param $bodyBytes i32) (param $nonce i32) (result i32)
  (local $2 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 8
  i32.sub
